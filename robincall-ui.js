...
async function performDestruction(channelId, source = 'local') {
    ...
    // source='local' — создатель, ждёт дольше чтобы юзер Б успел
    // source='remote' — получатель, чистится сразу
